import svgPaths from "./svg-vswfa4yo6x";
...
function Button1() {
  return (
    <div
      className="bg-[#3874ff] box-border content-stretch flex flex-row gap-1 items-center justify-center leading-[0] px-2 py-1 relative rounded shrink-0"
      data-name="Button"
    >
      <IconLeft1 />
    ...
    >
      ...
      <div className="flex flex-row items-center self-stretch">
        <div
          ...
          style={
            {
              "--transform-inner-width": "26",
              "--transform-inner-height": "26",
              width:
...
function Toolbar() {
  return (
    <div
      className="absolute bg-[#2d364d] box-border content-stretch flex flex-row items-center justify-between left-[76px] p-0 top-12 w-[1791px]"
      data-name="Toolbar"
    >
      <ListToolbar />
    </div>
...
function SidebarCollapsedTitlebar() {
  return (
    <div
      className="h-12 relative shrink-0 w-[52px]"
...
function Group42070() {
  return (
    <div className="absolute inset-[4.167%]">
      ...
      >
        <g id="Group 42070">
          <g filter="url(#filter0_i_445_110704)" id="Rectangle 1620">
            <path d={svgPaths.p37738600} fill="var(--fill-0, #F0F0F0)" />
          </g>
          <foreignObject height="9" width="19" x="2" y="-1">
            <div
              style={{
                backdropFilter: "blur(2px)",
                clipPath: "url(#bgblur_0_445_110704_clip_path)",
                height: "100%",
                width: "100%",
              }}
          ...
          <foreignObject height="9" width="17" x="2" y="1">
            <div
              style={{
                backdropFilter: "blur(2px)",
                clipPath: "url(#bgblur_1_445_110704_clip_path)",
                height: "100%",
                width: "100%",
              }}
              xmlns="http://www.w3.org/1999/xhtml"
          ...
          <foreignObject height="9" width="13" x="2" y="3">
            <div
              style={{
                backdropFilter: "blur(2px)",
                clipPath: "url(#bgblur_2_445_110704_clip_path)",
                height: "100%",
                width: "100%",
              }}
              xmlns="http://www.w3.org/1999/xhtml"
          ...
          <path
            ...
            id="Line 143 (Stroke)"
          />
          <g filter="url(#filter4_i_445_110704)" id="Frame 1">
            <g clipPath="url(#clip3_445_110704)">
              <rect
                fill="url(#paint0_linear_445_110704)"
                height="8"
                rx="1"
                width="16"
                y="11"
              />
              <g filter="url(#filter5_d_445_110704)" id="PDF">
                <path d={svgPaths.p6b34580} fill="var(--fill-0, white)" />
                <path d={svgPaths.pa9d0740} fill="var(--fill-0, white)" />
                <path d={svgPaths.p3d6ed980} fill="var(--fill-0, white)" />
              </g>
              <g id="PDF (Stroke)"></g>
            </g>
          </g>
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              in2="shape"
              mode="normal"
              result="effect1_innerShadow_445_110704"
            />
          </filter>
          <clipPath
            id="bgblur_0_445_110704_clip_path"
            transform="translate(-2 1)"
          >
            <path clipRule="evenodd" d={svgPaths.p6d97f00} fillRule="evenodd" />
          </clipPath>
          <clipPath
            id="bgblur_1_445_110704_clip_path"
            transform="translate(-2 -1)"
          >
            <path
              clipRule="evenodd"
          ...
          <clipPath
            id="bgblur_2_445_110704_clip_path"
          ...
          >
            ...
            <feBlend
              in2="BackgroundImageFix"
              mode="normal"
              result="effect1_dropShadow_445_110704"
            />
            <feBlend
              in="SourceGraphic"
              in2="effect1_dropShadow_445_110704"
              mode="normal"
              result="shape"
            />
          </filter>
...
function Header() {
  return (
    <div
      className="bg-[#242c40] relative rounded shrink-0 w-full"
      data-name="Header"
    >
      <div className="absolute border border-[#3874ff] border-solid inset-0 pointer-events-none rounded shadow-[0px_0px_11px_1px_#272d3f]" />
      <div className="flex flex-row items-center relative size-full">
...
function Frame2() {
  return (
    <div className="absolute backdrop-blur-[1.15px] backdrop-filter bottom-[13.043%] left-[4.545%] right-[27.273%] rounded-[1px] top-[56.522%]">
      <div className="overflow-clip relative size-full">
        <div
          className="absolute h-1 left-[1.5px] top-[1.5px] w-[11px]"
          data-name="XLS"
        >
          <div className="absolute bottom-[-52.5%] left-[-19.941%] right-[-19.091%] top-[-52.5%]">
            <svg
              className="block size-full"
              fill="none"
              preserveAspectRatio="none"
              viewBox="0 0 17 10"
            >
              <g filter="url(#filter0_d_445_110666)" id="XLS">
                <path d={svgPaths.p104bb100} fill="var(--fill-0, #EAEAEA)" />
                <path d={svgPaths.p245b6880} fill="var(--fill-0, #EAEAEA)" />
                <path d={svgPaths.p137f5280} fill="var(--fill-0, #EAEAEA)" />
                <path
                  d={svgPaths.p38f38880}
              ...
              <defs>
                ...
                >
                  ...
                  <feColorMatrix
                    type="matrix"
                    values="0 0 0 0 0.578882 0 0 0 0 0.647175 0 0 0 0 0.794545 0 0 0 1 0"
                  />
                  <feBlend
                    in2="BackgroundImageFix"
                    mode="normal"
                    result="effect1_dropShadow_445_110666"
                  />
                  <feBlend
                    in="SourceGraphic"
                    in2="effect1_dropShadow_445_110666"
                    mode="normal"
                    result="shape"
                  />
                </filter>
      ...
      <div className="absolute border-[#b8bfcf] border-[0.2px] border-solid inset-0 pointer-events-none rounded-[1px]" />
    </div>
  );
}
...
function Frame42677() {
  return (
    <div className="relative shrink-0 size-6">
      <div className="absolute bottom-[4.348%] left-[18.182%] right-[4.545%] top-[8.696%]">
        <svg
          className="block size-full"
          fill="none"
          preserveAspectRatio="none"
          viewBox="0 0 19 21"
        >
          <g filter="url(#filter0_i_445_110690)" id="Rectangle 1620">
            <path d={svgPaths.p1247e980} fill="var(--fill-0, #586A9C)" />
          </g>
          <defs>
            <filter
              colorInterpolationFilters="sRGB"
            ...
            >
              ...
              <feBlend
                in2="shape"
                mode="normal"
                result="effect1_innerShadow_445_110690"
              />
            </filter>
          </defs>
        </svg>
      </div>
      <div className="absolute bottom-[78.261%] left-[31.818%] right-[54.545%] top-[21.739%]">
        <div className="absolute bottom-[-0.75px] left-[-22.917%] right-[-22.917%] top-[-0.75px]">
          <svg
            className="block size-full"
            fill="none"
            preserveAspectRatio="none"
            viewBox="0 0 6 2"
          >
            <foreignObject height="9.5" width="12.7727" x="-3.75" y="-3.75">
              <div
                style={{
                  backdropFilter: "blur(2px)",
                  height: "100%",
            ...
            <path
              ...
              id="Line 141"
              opacity="0.9"
              stroke="url(#paint0_linear_445_110633)"
              strokeLinecap="round"
              strokeWidth="1.5"
            />
            <defs>
              ...
              >
                ...
                <stop offset="0.727217" stopColor="#A3BBF1" />
              </linearGradient>
            </defs>
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[65.217%] left-[31.818%] right-[54.545%] top-[34.783%]">
        <div className="absolute bottom-[-0.75px] left-[-22.917%] right-[-22.917%] top-[-0.75px]">
          <svg
            className="block size-full"
            fill="none"
      ...
      <div className="absolute bottom-[52.174%] left-[31.818%] right-[54.545%] top-[47.826%]">
        <div className="absolute bottom-[-0.75px] left-[-22.917%] right-[-22.917%] top-[-0.75px]">
          <svg
            className="block size-full"
            fill="none"
      ...
      <div className="absolute bottom-[78.261%] left-[54.545%] right-[36.364%] top-[21.739%]">
        <div className="absolute bottom-[-0.75px] left-[-34.375%] right-[-34.375%] top-[-0.75px]">
          <svg
            className="block size-full"
            fill="none"
            preserveAspectRatio="none"
            viewBox="0 0 4 2"
          >
            <foreignObject height="9.5" width="11.6818" x="-3.75" y="-3.75">
              <div
                style={{
                  backdropFilter: "blur(2px)",
                  height: "100%",
            ...
            <path
              ...
              id="Line 144"
              opacity="0.9"
              stroke="url(#paint0_linear_445_110647)"
              strokeLinecap="round"
              strokeWidth="1.5"
            />
            <defs>
      ...
      <div className="absolute bottom-[65.217%] left-[54.545%] right-[36.364%] top-[34.783%]">
        <div className="absolute bottom-[-0.75px] left-[-34.375%] right-[-34.375%] top-[-0.75px]">
          <svg
            className="block size-full"
            fill="none"
      ...
      <div className="absolute bottom-[52.174%] left-[54.545%] right-[36.364%] top-[47.826%]">
        <div className="absolute bottom-[-0.75px] left-[-34.375%] right-[-34.375%] top-[-0.75px]">
          <svg
            className="block size-full"
            fill="none"
      ...
      <div className="absolute bottom-[78.261%] left-[72.727%] right-[18.182%] top-[21.739%]">
        <div className="absolute bottom-[-0.75px] left-[-34.375%] right-[-34.375%] top-[-0.75px]">
          <svg
            className="block size-full"
            fill="none"
      ...
      <div className="absolute bottom-[65.217%] left-[72.727%] right-[18.182%] top-[34.783%]">
        <div className="absolute bottom-[-0.75px] left-[-34.375%] right-[-34.375%] top-[-0.75px]">
          <svg
            className="block size-full"
            fill="none"
      ...
      <div className="absolute bottom-[52.174%] left-[72.727%] right-[18.182%] top-[47.826%]">
        <div className="absolute bottom-[-0.75px] left-[-34.375%] right-[-34.375%] top-[-0.75px]">
          <svg
            className="block size-full"
            fill="none"
...
function Header1() {
  return (
    <div
      className="bg-[#242c40] box-border content-stretch flex flex-row gap-2 items-center justify-start p-[8px] relative rounded shrink-0"
      data-name="Header"
    >
      <Frame42677 />
    </div>
...
function NoOfListCollapsed() {
  return (
    <div
      className="basis-0 bg-[#242c40] box-border content-stretch flex flex-col gap-1 grow items-center justify-start min-h-px min-w-px overflow-x-clip overflow-y-auto px-0 py-3 relative shrink-0 w-full"
      data-name="No of List Collapsed"
    >
      <Header />
      <Header1 />
    </div>
...
function NavigatingSections() {
  return (
    <div
      className="basis-0 box-border content-stretch flex flex-col grow items-center justify-center min-h-px min-w-px p-0 relative shrink-0 w-[52px]"
      data-name="Navigating Sections"
    >
      <NoOfListCollapsed />
    </div>
  );
...
function SidebarSkeleton() {
  return (
    ...
    >
      ...
      <div className="absolute border border-[#505767] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
...
function Sidebar() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col h-[752px] items-start justify-start left-0 p-0 top-[47px] w-[76px]"
      data-name="Sidebar"
    >
      <SidebarSkeleton />
    </div>
      ...
      >
        <g id="Mark">
          <path
            ...
            fill="url(#paint0_linear_445_110680)"
            id="Rectangle 1805"
          />
          <path
            d={svgPaths.p2f5870f2}
            fill="url(#paint1_linear_445_110680)"
            id="Rectangle 1805_2"
          />
          <path
            d={svgPaths.p30e32800}
            fill="url(#paint2_linear_445_110680)"
            id="Rectangle 1813"
          />
          <path
            d={svgPaths.p11744380}
            fill="url(#paint3_linear_445_110680)"
            id="Rectangle 1807"
          />
          <path
            d={svgPaths.p31e5ac00}
            fill="url(#paint4_linear_445_110680)"
            id="Rectangle 1806"
          />
        </g>
        <defs>
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 18 18"
      >
        <g clipPath="url(#clip0_445_110672)" id="arrow_dropdown">
          <g id="Vector"></g>
          <path
        ...
        >
          <g id="icon">
            <path
              ...
              fill="url(#paint0_linear_445_110649)"
              fillRule="evenodd"
              id="Body"
            />
            <foreignObject height="15.4243" width="17.9047" x="-3" y="2.91736">
              <div
                style={{
                  ...
                  clipPath: "url(#bgblur_0_445_110649_clip_path)",
                  height: "100%",
                  width: "100%",
                }}
                xmlns="http://www.w3.org/1999/xhtml"
            ...
            <g
              ...
              filter="url(#filter0_i_445_110649)"
              id="Shape 1"
            >
              <rect
                fill="url(#paint1_linear_445_110649)"
                height="9.42427"
                rx="2"
                width="11.9047"
                y="5.91736"
            ...
            >
              <div
                style={{
                  ...
                  clipPath: "url(#bgblur_1_445_110649_clip_path)",
                  height: "100%",
                  width: "100%",
                }}
                xmlns="http://www.w3.org/1999/xhtml"
            ...
            <g
              ...
              filter="url(#filter1_d_445_110649)"
              id="Union"
            >
              <mask fill="white" id="path-3-inside-1_445_110649">
                <path d={svgPaths.p13548a80} />
              </mask>
              <path
                d={svgPaths.p13548a80}
                fill="url(#paint2_linear_445_110649)"
                shapeRendering="crispEdges"
              />
              <path
                d={svgPaths.p1a275800}
                fill="url(#paint3_linear_445_110649)"
                mask="url(#path-3-inside-1_445_110649)"
              />
            </g>
          </g>
          <defs>
            ...
            >
              ...
              <feBlend
                in2="shape"
                mode="normal"
                result="effect1_innerShadow_445_110649"
              />
            </filter>
            <clipPath
              id="bgblur_0_445_110649_clip_path"
            ...
            >
              ...
              <feBlend
                in2="BackgroundImageFix"
                mode="normal"
                result="effect1_dropShadow_445_110649"
              />
              <feBlend
                in="SourceGraphic"
                in2="effect1_dropShadow_445_110649"
                mode="normal"
                result="shape"
              />
            </filter>
            <clipPath
              id="bgblur_1_445_110649_clip_path"
...
function GlobalNavigation() {
  return (
    <div
      className="absolute bg-[#1f2432] h-12 left-0 right-0 top-0"
...
export default function Component27() {
  return (
    <div className="bg-[#c9d1e5] relative size-full" data-name="27">
      <Toolbar />
      <Sidebar />
      <GlobalNavigation />
    </div>
