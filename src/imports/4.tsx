import svgPaths from "./svg-olpmow052q";
        ...
        >
          <div className="absolute bottom-[-52.5%] left-[-19.941%] right-[-19.091%] top-[-52.5%]">
            <svg
              ...
              viewBox="0 0 17 10"
            >
              <g filter="url(#filter0_d_437_110306)" id="XLS">
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    in2="BackgroundImageFix"
                    mode="normal"
                    result="effect1_dropShadow_437_110306"
                  />
                  <feBlend
                    in="SourceGraphic"
                    in2="effect1_dropShadow_437_110306"
                    mode="normal"
                    result="shape"
                  />
                </filter>
    ...
    <div className="relative shrink-0 size-6">
      <div className="absolute bottom-[4.348%] left-[18.182%] right-[4.545%] top-[8.696%]">
        <svg
          ...
          viewBox="0 0 19 21"
        >
          <g filter="url(#filter0_i_437_110342)" id="Rectangle 1620">
          ...
          <defs>
            ...
            >
              ...
              <feBlend
                in2="shape"
                mode="normal"
                result="effect1_innerShadow_437_110342"
              />
            </filter>
          </defs>
        </svg>
        ...
        <div className="absolute bottom-[-0.75px] left-[-22.917%] right-[-22.917%] top-[-0.75px]">
          ...
          >
            ...
            <path
              ...
              id="Line 141"
              opacity="0.9"
              stroke="url(#paint0_linear_437_110289)"
              strokeLinecap="round"
              strokeWidth="1.5"
            />
            <defs>
        ...
        <div className="absolute bottom-[-0.75px] left-[-34.375%] right-[-34.375%] top-[-0.75px]">
          ...
          >
            ...
            <path
              ...
              id="Line 144"
              opacity="0.9"
              stroke="url(#paint0_linear_437_110308)"
              strokeLinecap="round"
              strokeWidth="1.5"
            />
            <defs>
      ...
      >
        <g id="Group 42066">
          <path
            ...
            fill="url(#paint0_linear_215_12368)"
            id="Rectangle 1805"
          />
          <path
            d={svgPaths.p2f5870f2}
            fill="url(#paint1_linear_215_12368)"
            id="Rectangle 1805_2"
          />
          <path
            d={svgPaths.p30e32800}
            fill="url(#paint2_linear_215_12368)"
            id="Rectangle 1813"
          />
          <path
            d={svgPaths.p11744380}
            fill="url(#paint3_linear_215_12368)"
            id="Rectangle 1807"
          />
          <path
            d={svgPaths.p31e5ac00}
            fill="url(#paint4_linear_215_12368)"
            id="Rectangle 1806"
          />
        </g>
        <defs>
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 18 18"
      >
        <g clipPath="url(#clip0_400_128582)" id="arrow_dropdown">
          <g id="Vector"></g>
          <path
        ...
        >
          <g id="icon">
            <path
              ...
              fill="url(#paint0_linear_400_128565)"
              fillRule="evenodd"
              id="Body"
            />
            <foreignObject height="15.4243" width="17.9047" x="-3" y="2.91736">
              <div
                style={{
                  ...
                  clipPath: "url(#bgblur_0_400_128565_clip_path)",
                  height: "100%",
                  width: "100%",
                }}
                xmlns="http://www.w3.org/1999/xhtml"
            ...
            <g
              ...
              filter="url(#filter0_i_400_128565)"
              id="Shape 1"
            >
              <rect
                fill="url(#paint1_linear_400_128565)"
                height="9.42427"
                rx="2"
                width="11.9047"
                y="5.91736"
            ...
            >
              <div
                style={{
                  ...
                  clipPath: "url(#bgblur_1_400_128565_clip_path)",
                  height: "100%",
                  width: "100%",
                }}
                xmlns="http://www.w3.org/1999/xhtml"
            ...
            <g
              ...
              filter="url(#filter1_d_400_128565)"
              id="Union"
            >
              <mask fill="white" id="path-3-inside-1_400_128565">
                <path d={svgPaths.p13548a80} />
              </mask>
              <path
                d={svgPaths.p13548a80}
                fill="url(#paint2_linear_400_128565)"
                shapeRendering="crispEdges"
              />
              <path
                d={svgPaths.p1a275800}
                fill="url(#paint3_linear_400_128565)"
                mask="url(#path-3-inside-1_400_128565)"
              />
            </g>
          </g>
          <defs>
            ...
            >
              ...
              <feBlend
                in2="shape"
                mode="normal"
                result="effect1_innerShadow_400_128565"
              />
            </filter>
            <clipPath
              id="bgblur_0_400_128565_clip_path"
            ...
            >
              ...
              <feBlend
                in2="BackgroundImageFix"
                mode="normal"
                result="effect1_dropShadow_400_128565"
              />
              <feBlend
                in="SourceGraphic"
                in2="effect1_dropShadow_400_128565"
                mode="normal"
                result="shape"
              />
            </filter>
            <clipPath
              id="bgblur_1_400_128565_clip_path"
      ...
      >
        <g id="Logo">
          ...
          <path
            ...
            fill="url(#paint0_linear_437_110278)"
            id="Logo_2"
          />
        </g>
        <defs>
...
export default function Component4() {
  return (
    <div className="bg-[#c9d1e5] relative size-full" data-name="4">
      <Toolbar />
      <Sidebar />
      <GlobalNavigation />
    </div>
