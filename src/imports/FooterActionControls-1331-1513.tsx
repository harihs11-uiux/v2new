import svgPaths from "./svg-gbxbo405cc";
...
function NoOfIcons112Px18Px() {
  return (
    <div className="[grid-area:1_/_1] box-border content-stretch flex gap-3 items-center justify-start ml-0 mt-0 relative" data-name="No. of Icons /1/12 px/18 px">
      <IconSkeleton10 />
    </div>
  );
}
...
function Button() {
  return (
    <div className="box-border content-stretch flex gap-1 items-center justify-center leading-[0] px-2 py-1 relative rounded shrink-0" data-name="Button">
      <IconLeft />
      <div className="flex flex-col font-['Inter:Semi_Bold',_sans-serif] font-semibold justify-center not-italic relative shrink-0 text-[#3874ff] text-[14px] text-nowrap">
        <p className="leading-[18px] whitespace-pre">1 items selected</p>
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[18px]" data-name="Icon Skeleton 10">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Icon Skeleton 10">
          <mask height="18" id="mask0_1331_1517" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="18" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="18" id="Bounding box" width="18" />
          </mask>
          <g mask="url(#mask0_1331_1517)">
            <path d={svgPaths.p21f4e080} fill="var(--fill-0, #9497A1)" id="edit" />
          </g>
        </g>
      </svg>
    </div>
  ...
  return (
    <div className="box-border content-stretch flex gap-1 items-center justify-center leading-[0] px-2 py-1 relative rounded shrink-0" data-name="Button">
      ...
      <div className="flex flex-col font-['Inter:Semi_Bold',_sans-serif] font-semibold justify-center not-italic relative shrink-0 text-[#ffffff] text-[14px] text-nowrap">
        <p className="leading-[18px] whitespace-pre">Edit Invoice</p>
      </div>
    </div>
  );
}
...
export default function FooterActionControls() {
  return (
    <div className="bg-[#050e25] content-stretch flex gap-2 items-center justify-start relative rounded-lg size-full" data-name="Footer action Controls">
      <Button />
          ...
          <div className="h-0 relative w-5" data-name="Seperator">
            <div className="absolute bottom-0 left-0 right-0 top-[-1px]" style={{ "--stroke-0": "rgba(80, 87, 103, 1)" } as React.CSSProperties}>
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 1">
                <line id="Seperator" stroke="var(--stroke-0, #505767)" x2="20" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
