import svgPaths from "./svg-qvlc5dei9a";

function SuccessCheck() {
  return (
    <div
      className="absolute left-[1.125px] size-[15.75px] top-[1.125px]"
      data-name="Success check"
    >
      <svg
...
function Button() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-1 items-center justify-center px-2 py-1 relative rounded shrink-0"
      data-name="Button"
    >
      <div className="absolute border border-[#050e25] border-solid inset-0 pointer-events-none rounded" />
      <IconLeft />
...
export default function FooterActionControls() {
  return (
    <div
      className="bg-[#050e25] relative rounded-3xl size-full"
      data-name="Footer action Controls"
    >
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start px-2 py-0 relative size-full">
          <Button />
