import svgPaths from "./svg-fgh6cwmqo6";
...
function Frame11() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-start left-[12px] top-[448px] w-[266px]">
      <Logo1 />
      <Button1 />
    </div>
  );
...
function UserPov() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[4px] items-end justify-center right-[12px] rounded-[16px] top-[380px]" data-name="User Pov">
      <UserQuestion />
    </div>
  );
}
