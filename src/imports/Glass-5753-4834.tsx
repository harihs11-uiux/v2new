import svgPaths from "./svg-7gvq6hjmv0";
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px not-italic relative">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] relative shrink-0 text-[14px] text-white">{`You’re now in Customs Support. `}</p>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] min-w-full relative shrink-0 text-[12px] text-[rgba(255,255,255,0.69)] w-[min-content] whitespace-pre-wrap">You’re now in Customs Support. Tell us what you need help with.</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px relative">
      <div className="flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-h-px min-w-px not-italic relative text-[12px] text-white">
        <p className="leading-[18px] whitespace-pre-wrap">What is HSN?</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">
        <p className="leading-[18px]">what is SVB?</p>
      </div>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">
        <p className="leading-[18px]">What is a commercial invoice?</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[rgba(255,255,255,0.24)] relative rounded-[16px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center p-[8px] relative w-full">
          <Lightbulb3 />
          <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">
            <p className="leading-[18px]">What is a packing list?</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] items-start left-[40px] top-[170px] w-[238px]">
