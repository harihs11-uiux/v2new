import svgPaths from "./svg-ws0dlxb42q";

function Group42122() {
  return (
    <div className="absolute h-2.5 left-0 top-[201px] w-[6.543px]">
      <svg
      ...
      >
        <g id="Group 42122">
          <path
            d="M0 5.5L6.54264 0V10L0 5.5Z"
            fill="var(--fill-0, #050E25)"
            id="Rectangle 274636"
          />
        </g>
      </svg>
...
function ClockLoader21() {
  return (
    <div
      className="absolute left-4 size-5 top-[88px]"
      data-name="clock_loader_20"
    >
      <svg
        className="block size-full"
...
function ClockLoader22() {
  return (
    <div
      className="absolute left-4 size-5 top-[150px]"
      data-name="clock_loader_20"
    >
      <svg
        className="block size-full"
...
function ClockLoader23() {
  return (
    <div
      className="absolute left-4 size-5 top-[212px]"
      data-name="clock_loader_20"
    >
      <svg
        className="block size-full"
...
function ClockLoader24() {
  return (
    <div
      className="absolute left-4 size-5 top-[274px]"
      data-name="clock_loader_20"
    >
      <svg
        className="block size-full"
...
function ClockLoader25() {
  return (
    <div
      className="absolute left-4 size-5 top-[342px]"
      data-name="clock_loader_20"
    >
      <svg
        className="block size-full"
...
export default function Group42123() {
  return (
