...
import svgPaths from "./svg-7c3pqu73m6";
...
const MOCK_DATA: Record<string, string[]> = {
  // Imports Data
  "Bond No.": ["BOND-001", "BOND-002", "BOND-003", "BOND-004", "BOND-005"],
  "Port of Shipment": ["Mumbai", "Chennai", "Kolkata", "Nhava Sheva", "Mundra"],
  "IGM No.": ["IGM-101", "IGM-102", "IGM-103", "IGM-104", "IGM-105"],
  "HAWB/HBL No.": ["HAWB-201", "HAWB-202", "HAWB-203", "HAWB-204", "HAWB-205"],
  "MAWB No.": ["MAWB-301", "MAWB-302", "MAWB-303", "MAWB-304", "MAWB-305"],
  "Seal No.": ["SEAL-401", "SEAL-402", "SEAL-403", "SEAL-404", "SEAL-405"],
  
  // Exports Data
  "Seal no": ["SEAL-401", "SEAL-402", "SEAL-403", "SEAL-404", "SEAL-405"],
  "RBI Waiver No.": ["RBI-991", "RBI-992", "RBI-993", "RBI-994", "RBI-995"],
  "Excise Seal No.": ["EX-SEAL-01", "EX-SEAL-02", "EX-SEAL-03", "EX-SEAL-04"],
  "Container No.": ["CONT-881", "CONT-882", "CONT-883", "CONT-884", "CONT-885"],
  "Port of Discharge": ["Dubai", "Singapore", "New York", "London", "Rotterdam"],
};
...
function FilterGrid({ 
  ...
  return (
    <div className="content-stretch flex gap-[48px] items-start relative shrink-0 w-[1201px]" data-name="Filter Grid">
      ...
      <RowOfChips labels={labels} filters={filters} setFilters={setFilters} />
    </div>
  );
}

export default function RightPanelContent({ filters = {}, setFilters = () => {}, activeView = 'Imports' }: { filters?: Record<string, string[]>; setFilters?: (val: Record<string, string[]>) => void; activeView?: 'Imports' | 'Exports' }) {
  if (activeView === 'Exports') {
    return (
      <div className="bg-[#2d364d] content-stretch flex flex-col gap-[24px] items-start px-[24px] py-[16px] relative size-full" data-name="Right Panel Content">
        <FilterGrid 
          title="Job Details" 
  ...
  return (
    <div className="bg-[#2d364d] content-stretch flex flex-col gap-[24px] items-start px-[24px] py-[16px] relative size-full" data-name="Right Panel Content">
      ...
      <FilterGrid 
        title="Shipment Details" 
        labels={["Port of Shipment"]} 
        filters={filters} 
        setFilters={setFilters} 
      />
      <FilterGrid 
        title="IGM Details" 
        labels={["IGM No.", "HAWB/HBL No.", "MAWB No.", "Seal No."]} 
        filters={filters} 
        setFilters={setFilters} 
      />
    </div>
