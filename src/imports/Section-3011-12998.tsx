import svgPaths from "./svg-nx88nv3zlb";
...
function GraphBase() {
  return (
    <div className="absolute flex h-[236px] items-center justify-between left-[135px] w-[236px] top-[calc(50%-8.5px)] translate-y-[-50%]" data-name="Graph Base">
...
function Graph() {
  return (
    <div className="h-[253px] relative shrink-0 w-[375px]" data-name="Graph">
      <GraphBase />
      <Parameter5 />
      <Footer />
    </div>
  ...
  return (
    <div className="bg-white relative rounded-[8px] shrink-0 w-full" data-name="Horizontal Graph">
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[32px] items-center justify-center p-[16px] relative w-full">
          <GraphFilter />
          <Graph />
        </div>
      </div>
