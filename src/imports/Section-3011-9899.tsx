import svgPaths from "./svg-19wd60f90b";
import imgRectangle from "figma:asset/73a3f987b8a9b1d20da3025b0eb5eda864814ba7.png";
import imgRectangle1 from "figma:asset/d8582cbe37be3d46afacb57db4c949136a085261.png";
    ...
    <div className="relative shrink-0 size-[18px]" data-name="Icon Skeleton 2">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Icon Skeleton 2">
          <mask height="18" id="mask0_3011_10073" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="18" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="18" id="Bounding box" width="18" />
          </mask>
          <g mask="url(#mask0_3011_10073)">
...
function Bar() {
  return (
    <div className="basis-0 content-stretch flex gap-[8px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Bar">
      <div className="basis-0 flex grow h-[30px] items-center justify-center min-h-px min-w-px relative shrink-0" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
...
function Frame1() {
  return (
    <div className="basis-0 grow h-[30px] min-h-px min-w-px relative shrink-0">
      <div className="absolute flex h-[30px] items-center justify-center left-0 right-0 top-0">
        <div className="flex-none h-[195px] rotate-[90deg] w-[30px]">
