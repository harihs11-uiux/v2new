...
interface SectionProps {
  onTabChange?: (tab: 'Imports', filter?: { status?: string; limit?: number }) => void;
}
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="outline-none">
        <div className="content-stretch flex gap-[4px] items-center p-[4px] relative shrink-0 w-[158px] cursor-pointer" data-name="Dropdown">
      ...
      <DropdownMenuContent align="end">
        <DropdownMenuItem onClick={() => setSelectedOption("Last 365")}>
          Last 365
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => setSelectedOption("This Month")}>
          This Month
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => setSelectedOption("Today")}>
          Today
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => setSelectedOption("Custom Date")}>
          Custom Date
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="No. of Icons">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="outline-none">
            <div className="relative shrink-0 size-[18px] cursor-pointer hover:opacity-80" data-name="Icon Download">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={() => console.log("Download XL")}>
              Download XL
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
...
function MetricsCard({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div 
      className="bg-white h-[68px] relative rounded-[4px] shrink-0 w-full transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" 
      data-name="Metrics Card"
    >
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
          ...
          <p 
            className="leading-[28px] relative shrink-0 text-[#3874ff] text-[20px] w-full cursor-pointer hover:underline" 
...
function MetricsCard1({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div 
      className="bg-white h-[68px] relative rounded-[4px] shrink-0 w-full transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" 
      data-name="Metrics Card"
...
function MetricsCard2({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div 
      className="bg-white h-[68px] relative rounded-[4px] shrink-0 w-full transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" 
      data-name="Metrics Card"
...
function MetricsCard3({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="content-start flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Metrics Card">
      <MetricsCard onTabChange={onTabChange} />
      <MetricsCard1 onTabChange={onTabChange} />
      <MetricsCard2 onTabChange={onTabChange} />
    </div>
  );
}

function MetricsCard4({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
          <p className="leading-[16px] relative shrink-0 text-[#050e25] text-[12px] w-full">BOE Amendments</p>
          <p className="leading-[28px] relative shrink-0 text-[#3874ff] text-[20px] w-full cursor-pointer hover:underline" onClick={() => onTabChange?.('Imports')}>99</p>
        </div>
      </div>
    </div>
  );
...
function MetricsCard5({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
...
function MetricsCard6({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
...
function MetricsCard7({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="content-start flex flex-wrap gap-[8px] items-start relative shrink-0 w-full" data-name="Metrics Card">
      <MetricsCard4 onTabChange={onTabChange} />
      <MetricsCard5 onTabChange={onTabChange} />
      <MetricsCard6 onTabChange={onTabChange} />
    </div>
  );
}

function MetricsCard8({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
...
function MetricsCard11({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="content-start flex flex-wrap gap-[8px] items-start relative shrink-0 w-full" data-name="Metrics Card">
      <MetricsCard8 onTabChange={onTabChange} />
      <MetricsCard9 />
      <MetricsCard10 />
    </div>
  );
...
function Card({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Card">
      <MetricsCard3 onTabChange={onTabChange} />
    </div>
  );
}

function CardRows({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Card Rows">
      <Card onTabChange={onTabChange} />
    </div>
  );
}

function Frame({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="w-[20%] content-stretch flex flex-col gap-[8px] items-start min-h-px min-w-px relative shrink-0">
      <HeadingUtilities />
      <CardRows onTabChange={onTabChange} />
    </div>
  );
}
  ...
  return (
    <div className="basis-0 content-stretch flex gap-[8px] grow items-center min-h-px min-w-px relative shrink-0" data-name="Heading">
      ...
      <div className="basis-0 flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold grow justify-center leading-[0] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#626776] text-[14px] text-nowrap">
        <p className="leading-[18px] overflow-ellipsis overflow-hidden">Pending Jobs : 79</p>
      </div>
    </div>
  );
}
...
function MetricsCard12({ onTabChange }: { onTabChange?: (tab: 'Imports', filter?: { status?: string; limit?: number }) => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shadow-[0px_0px_6px_0px_#b0bce0] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
          <p className="leading-[16px] relative shrink-0 text-[#050e25] text-[12px] w-full">Checklist Preparation</p>
          <p className="leading-[28px] relative shrink-0 text-[#3874ff] text-[20px] w-full cursor-pointer hover:underline" onClick={() => onTabChange?.('Imports', { status: 'Job Created', limit: 20 })}>20</p>
        </div>
      </div>
    </div>
  );
...
function MetricsCard13({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
          <p className="leading-[16px] relative shrink-0 text-[#050e25] text-[12px] w-full">Checklist Approval</p>
          <p className="leading-[28px] relative shrink-0 text-[#3874ff] text-[20px] w-full cursor-pointer hover:underline" onClick={() => onTabChange?.('Imports')}>10</p>
        </div>
      </div>
    </div>
  );
...
function MetricsCard14({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
          <p className="leading-[16px] relative shrink-0 text-[#050e25] text-[12px] w-full">Icegate Ack.</p>
          <p className="leading-[28px] relative shrink-0 text-[#3874ff] text-[20px] w-full cursor-pointer hover:underline" onClick={() => onTabChange?.('Imports')}>2</p>
        </div>
      </div>
    </div>
  );
...
function MetricsCard15({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
          <p className="leading-[16px] relative shrink-0 text-[#050e25] text-[12px] w-full">Query Reply</p>
          <p className="leading-[28px] relative shrink-0 text-[#3874ff] text-[20px] w-full cursor-pointer hover:underline" onClick={() => onTabChange?.('Imports')}>3</p>
        </div>
      </div>
    </div>
  );
...
function MetricsCard16({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
...
function MetricsCard17({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="content-start flex flex-wrap gap-[8px] items-start relative shrink-0 w-full" data-name="Metrics Card">
      <MetricsCard12 onTabChange={onTabChange} />
      <MetricsCard13 onTabChange={onTabChange} />
      <MetricsCard14 onTabChange={onTabChange} />
      <MetricsCard15 onTabChange={onTabChange} />
      <MetricsCard16 onTabChange={onTabChange} />
    </div>
  );
}

function MetricsCard18({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
          <p className="leading-[16px] relative shrink-0 text-[#050e25] text-[12px] w-full">IGM Regularize</p>
          <p className="leading-[28px] relative shrink-0 text-[#3874ff] text-[20px] w-full cursor-pointer hover:underline" onClick={() => onTabChange?.('Imports')}>5</p>
        </div>
      </div>
    </div>
  );
...
function MetricsCard19({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
          <p className="leading-[16px] relative shrink-0 text-[#050e25] text-[12px] w-full">First Copy</p>
          <p className="leading-[28px] relative shrink-0 text-[#3874ff] text-[20px] w-full cursor-pointer hover:underline" onClick={() => onTabChange?.('Imports')}>4</p>
        </div>
      </div>
    </div>
  );
...
function MetricsCard20({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
          <p className="leading-[16px] relative shrink-0 text-[#050e25] text-[12px] w-full">Examination</p>
          <p className="leading-[28px] relative shrink-0 text-[#3874ff] text-[20px] w-full cursor-pointer hover:underline" onClick={() => onTabChange?.('Imports')}>1</p>
        </div>
      </div>
    </div>
  );
...
function MetricsCard21({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
          <p className="leading-[16px] relative shrink-0 text-[#050e25] text-[12px] w-full">Duty payment</p>
          <p className="leading-[28px] relative shrink-0 text-[#3874ff] text-[20px] w-full cursor-pointer hover:underline" onClick={() => onTabChange?.('Imports')}>20</p>
        </div>
      </div>
    </div>
  );
...
function MetricsCard22({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
...
function MetricsCard23({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="content-start flex flex-wrap gap-[8px] items-start relative shrink-0 w-full" data-name="Metrics Card">
      <MetricsCard18 onTabChange={onTabChange} />
      <MetricsCard19 onTabChange={onTabChange} />
      <MetricsCard20 onTabChange={onTabChange} />
      <MetricsCard21 onTabChange={onTabChange} />
      <MetricsCard22 onTabChange={onTabChange} />
    </div>
  );
}

function MetricsCard24({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
...
function MetricsCard25({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
...
function MetricsCard26({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="basis-0 bg-white grow h-[68px] min-h-px min-w-px relative rounded-[4px] shrink-0 transition-all duration-200 hover:shadow-[0_4px_12px_rgba(0,0,0,0.15)]" data-name="Metrics Card">
      <div className="size-full">
        <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold gap-[8px] items-start not-italic p-[8px] relative size-full">
...
function MetricsCard29({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="content-start flex flex-wrap gap-[8px] items-start relative shrink-0 w-full" data-name="Metrics Card">
      <MetricsCard24 onTabChange={onTabChange} />
      <MetricsCard25 onTabChange={onTabChange} />
      <MetricsCard26 onTabChange={onTabChange} />
      <MetricsCard27 />
      <MetricsCard28 />
    </div>
  );
...
function Card1({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Card">
      <MetricsCard17 onTabChange={onTabChange} />
      <MetricsCard23 onTabChange={onTabChange} />
      <MetricsCard29 onTabChange={onTabChange} />
    </div>
  );
}

function CardRows1({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Card Rows">
      <Card1 onTabChange={onTabChange} />
    </div>
  );
}

function Frame1({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
    <div className="flex-1 content-stretch flex flex-col gap-[8px] items-start relative min-w-0">
      <HeadingUtilities1 />
      <CardRows1 onTabChange={onTabChange} />
    </div>
  );
}

function Frame2({ onTabChange }: { onTabChange?: (tab: 'Imports') => void }) {
  return (
...
export default function Section({ onTabChange }: SectionProps = {}) {
  return (
