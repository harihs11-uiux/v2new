import svgPaths from "./svg-sraoteg0so";
...
function CollapsedCard() {
  return (
    <div
      className="box-border content-stretch flex flex-col gap-2 h-9 items-center justify-center p-0 relative rounded shadow-[0px_0px_11px_1px_#272d3f] shrink-0 w-[43px]"
...
function CollapsedCard1() {
  return (
    <div
      className="bg-[#32394c] box-border content-stretch flex flex-col gap-2 items-center justify-center p-[8px] relative rounded shrink-0 w-[43px]"
      data-name="Collapsed Card"
    >
      <div
        aria-hidden="true"
...
function SidebarSkeleton() {
  return (
    <div
      className="bg-[#242c40] relative h-full w-full"
