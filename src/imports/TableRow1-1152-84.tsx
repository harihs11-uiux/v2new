import svgPaths from "./svg-n8hmq3mdwa";
...
function Body() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-2 items-center justify-start p-0 relative shrink-0 w-[193px]"
      data-name="Body"
    >
      <Arrow />
      <div className="flex flex-col font-['Inter:Semi_Bold',_sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#050e25] text-[12px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">Job Level</p>
      </div>
    </div>
  );
}
...
export default function TableRow1() {
  return (
    <div className="bg-[#f3f5fa] relative size-full" data-name="Table Row 1">
      <div className="flex flex-row items-center relative size-full">
