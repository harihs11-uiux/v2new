import svgPaths from "./svg-h7yjg4p0iy";
  ...
  return (
    <div className="basis-0 grow h-[30px] min-h-px min-w-px relative shrink-0" data-name="Invoice Seperator">
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex gap-2 h-[30px] items-center justify-start pl-1 pr-2 py-1.5 relative w-full">
          <Arrow />
...
export default function TableRow1() {
  return (
    <div className="bg-[#f4f6fb] relative size-full" data-name="Table Row 1">
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex items-center justify-start pl-2 pr-0 py-0 relative size-full">
          <Freezed />
        </div>
      </div>
      <div
